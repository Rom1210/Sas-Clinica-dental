    ...
    <div className="flex flex-col gap-8 animate-in fade-in duration-500 pb-20 relative">
      ...
      {activeTab === 'accounts' && (
        <>
          ...
          <AccountsTab 
            ...
            selectMode={searchParams.get('select_mode') === 'true'}
            onCancelSelection={() => setSearchParams({ tab: 'accounts' })}
          />
        </>
      )}
      ...
      {activeTab === 'invoices' && (
        <InvoicesTab 
          ...
          formatPrice={formatPrice} 
          setShowPaymentModal={setShowPaymentModal} 
          onEnterSelectionMode={() => setSearchParams({ tab: 'accounts', select_mode: 'true' })}
        />
      )}
